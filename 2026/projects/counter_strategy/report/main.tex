...
Test accuracy (65.5\%) trails cross-validated accuracy (73.7\%), so we use the model as a probabilistic prior rather than a deterministic rule.
...
Table \ref{tab:e2e} provides a comprehensive view of strategy performance across different game states. We flag low-confidence rows when $N < 20$.
