...
\begin{itemize}
    ...
    \item \textbf{Execution Metrics:} A subjective ``Success Rating'' (0-4) and the precise final coordinates ($x, y$) of the stone in sensor units (approximately 273 units per foot).
    \item \textbf{Outcomes:} The final score of the end, which serves as our ``ground truth'' label for strategic success.
\end{itemize}

Data preprocessing involved normalizing coordinate systems across different events, imputing missing shot types using spatial clustering, and aggregating shot-level data into end-level ``Performance Vectors'' for opponent profiling. Teams with fewer than 8 Power Play usages were excluded from clustering analysis to ensure statistical reliability.
...
\midrule
Guard Wall & 203 & 1.53 & 1.12 & 3.24 & 20.2\% & 0.0\% \\
Draw/Guard & 389 & 1.70 & 1.71 & 4.08 & 21.6\% & 0.0\% \\
\bottomrule
\end{tabular}
\end{table}
...
To move beyond abstract strategy, we analyzed the spatial distribution of shots using \textbf{Kernel Density Estimation (KDE)}. Figure \ref{fig:spatial} reveals the spatial patterns of defensive shots in Power Play ends.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/spatial_with_house.png}
    \caption{\textbf{Spatial Heatmap with House Overlay.} Draw/Guard shots in Power Play ends (N=389). The curling house rings are overlaid for reference. Coordinate units are sensor-based (approximately 273 units = 1 foot). The KDE reveals clustering near the house center.}
    \label{fig:spatial}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{\textbf{Spatial Distribution by Execution Quality.} High-quality shots (left) show tighter clustering than low-quality shots (right), validating the ``margin of error'' concept for training.}
...
\midrule
5 & Draw/Guard & 41 & 1.46 & 3.00 & 22.0\% & 0\% & Standard \\
5 & Guard Wall & 36 & 1.61 & 3.20 & 27.8\% & 0\% & Standard \\
6 & Draw/Guard & 123 & 1.62 & 3.38 & 23.6\% & 0\% & Standard \\
6 & Guard Wall & 81 & 1.38 & 3.15 & 16.0\% & 0\% & Standard \\
7 & Draw/Guard & 151 & 1.63 & 3.44 & 21.2\% & 0\% & Standard \\
7 & Guard Wall & 54 & 1.74 & 3.55 & 20.4\% & 0\% & Standard \\
8 & Draw/Guard & 53 & 2.66 & 9.00 & 26.4\% & 0\% & Standard \\
8 & Guard Wall & 11 & 1.91 & 3.00 & 36.4\% & 0\% & Standard \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Call:} Neither strategy in our data shows significant steal probability. Consider higher-variance plays not in our dataset (e.g., Runback) or accept the need to force with Hammer.
    \end{itemize}
...
\midrule
6 & -2 & Opp & Aggressive & Draw/Guard & 1.70 & 21.6\% & 0\% \\
6 & 0 & Opp & Standard & Guard Wall & 1.53 & 20.2\% & 0\% \\
6 & +2 & Opp & Conservative & Guard Wall & 1.53 & 20.2\% & 0\% \\
7 & -1 & Us & Aggressive & Draw/Guard & 1.70 & 21.6\% & 0\% \\
7 & +1 & Us & Standard & Guard Wall & 1.53 & 20.2\% & 0\% \\
8 & -2 & Opp & Aggressive & Draw/Guard & 1.70 & 21.6\% & 0\% \\
8 & 0 & Opp & Standard & Guard Wall & 1.53 & 20.2\% & 0\% \\
8 & +2 & Us & Conservative & Guard Wall & 1.53 & 20.2\% & 0\% \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
    ...
    \item \textbf{Steal Probability:} Our dataset shows 0\% steal probability for both main strategies, limiting our ability to recommend aggressive play. This may reflect elite-level defensive competence or data collection bias.
